 ...
 *
 * Copia intencional en `src/cajero/components/ProductCombobox.tsx` (esa zona
 * no importa nada de fuera de sí misma, ver punto 12 de
 * src/cajero/CLAUDE.md) — si cambias uno, cambia el otro.
 */
