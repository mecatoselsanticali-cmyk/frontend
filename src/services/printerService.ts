// Cliente del print-server local (ver print-server/ en la raíz del repo y
// docs/THERMAL_PRINTER_INTEGRATION.md). A propósito usa `fetch`, no los
// clientes axios de este proyecto (httpClient.ts) — el print-server es un
// proceso local de la terminal física, no la API en la nube, así que no
